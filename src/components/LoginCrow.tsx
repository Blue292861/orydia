  ...
  return (
    <div className="absolute -top-20 -right-4 sm:right-0 sm:-top-24 animate-fade-in-down w-64 z-20">
      <div className="relative flex items-end">
        ...
        <div className="relative bg-white text-black p-4 rounded-lg shadow-lg border-2 border-black ml-[-20px] mb-6">
          ...
          <div className="absolute -bottom-2 left-4 w-0 h-0 border-l-8 border-l-transparent border-r-8 border-r-transparent border-t-8 border-t-white transform -translate-x-1/2"></div>
        </div>
      </div>
    </div>
  );
